...
public class MemoryDatabase{
     ...
     private void AddDefaultMovies()
    {
        ...
        Category comedy = Categories.FirstOrDefault(c => c.Name == "Comedy");
        ...
        Movies.Add(new Movie { Id = 4, Title = "The Dark Knight", Director = "Christopher Nolan", ReleaseYear = 2008,Category = comedy, Actors = new List<Actor>()  });
        Movies.Add(new Movie { Id = 5, Title = "The Lord of the Rings: The Return of the King", Director = "Peter Jackson",Category = comedy, ReleaseYear = 2003, Actors = new List<Actor>()  });
